...
const LOCATION = LOCATIONS['port-charlotte']
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'Port Charlotte locksmith',
    'car locksmith Port Charlotte',
    '24 hour locksmith Port Charlotte',
    'emergency locksmith Port Charlotte',
    'locksmith near me Port Charlotte',
    'automotive locksmith Port Charlotte',
    'key programming Port Charlotte',
    'house lockout Port Charlotte',
    'locksmith Charlotte County',
    'car key replacement Port Charlotte',
  ],
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `Locksmith Services in Port Charlotte, Florida`,
      },
    ],
  },
}
...
// Generate schemas
const localBusinessSchema = generateLocalBusinessSchema('port-charlotte')
...
export default function LocksmithPortCharlottePage() {
  const services = [
    { 
      name: 'Car Lockout', 
    ...
    { 
      ...
      description: 'Fast, damage-free entry for Deep Creek, Charlotte Harbor & Harbor Heights homes.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { 
      name: 'Lock Rekeying', 
      link: '/residential-services',
      description: 'New to Port Charlotte? We rekey all locks so only your keys work.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    { 
      ...
      description: 'Serving Port Charlotte businesses from Murdock to Town Center area.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" />
        </svg>
    ...
    { 
      name: 'Smart Locks', 
      link: '/residential-services',
      description: 'Modern keyless entry systems for your Port Charlotte home or business.',
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center space-x-2 bg-[#7dd3e8]/20 border border-[#7dd3e8]/30 rounded-full px-4 py-2 mb-6">
              ...
              <span className="text-[#7dd3e8] font-medium">Serving Port Charlotte & Charlotte County</span>
            </div>
            <h1 className="text-4xl sm:text-5xl font-bold text-white mb-6">
              Locksmith <span className="text-[#7dd3e8]">Port Charlotte</span>
            </h1>
      ...
      {/* About Port Charlotte Service */}
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-[#1a3a52] mb-6 text-center">
              Your Trusted <span className="text-[#7dd3e8]">Port Charlotte</span> Locksmith
            </h2>
            <div className="prose prose-lg max-w-none text-gray-700">
              ...
              <p className="mb-4">
                ...
                From the waterfront properties along Charlotte Harbor to the growing neighborhoods of Mid County, 
                we provide comprehensive locksmith services for automotive, residential, and commercial needs.
              </p>
              <p>
                As a NASTF Certified automotive locksmith, we handle modern transponder keys and push-to-start systems 
                for all makes and models. Port Charlotte residents trust us for fair, upfront pricing and professional service—
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">
              Locksmith Services in <span className="text-[#7dd3e8]">Port Charlotte</span>
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Complete locksmith solutions for Charlotte County residents and businesses
            </p>
          </div>
      ...
      <section className="py-20 bg-gradient-to-b from-[#1a3a52] to-[#2c4a5f]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-white mb-4">
              We Cover All <span className="text-[#7dd3e8]">Port Charlotte</span> Neighborhoods
            </h2>
            <p className="text-gray-300 max-w-2xl mx-auto">
              Fast response times throughout Charlotte County
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h3 className="text-xl font-bold text-white mb-4">
              Port Charlotte ZIP Codes We Serve
            </h3>
            <div className="flex flex-wrap justify-center gap-3">
              {['33948', '33952', '33953', '33954', '33980', '33981', '33983'].map((zip, index) => (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-[#1a3a52] rounded-2xl p-8 border border-[#7dd3e8]/20">
            <h2 className="text-3xl font-bold text-white mb-8 text-center">
              Why Port Charlotte Chooses <span className="text-[#7dd3e8]">Unlock SRQ</span>
            </h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <p className="text-gray-400 text-sm">We know every neighborhood in Port Charlotte</p>
              </div>
              <div className="text-center">
                <div className="w-16 h-16 bg-[#7dd3e8] rounded-xl flex items-center justify-center mx-auto mb-4">
                  <svg className="w-8 h-8 text-[#1a3a52]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              ...
              <p className="text-gray-600">Yes! We cover all of Charlotte County including Port Charlotte, Punta Gorda, Englewood, Rotonda West, Deep Creek, Murdock, and Charlotte Harbor. Our mobile workshop comes fully equipped to handle any locksmith need on-site.</p>
            </div>
            <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
              <h3 className="text-lg font-bold text-[#1a3a52] mb-2">What zip codes do you serve in Port Charlotte?</h3>
              <p className="text-gray-600">We serve all Port Charlotte zip codes: 33948, 33952, 33953, 33954, 33980, 33981, and 33983. No matter which part of Port Charlotte you&apos;re in, we can help.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gradient-to-r from-[#1a3a52] to-[#2c4a5f]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-white mb-6">
            Need a Locksmith in Port Charlotte?
          </h2>
          <p className="text-gray-200 mb-8 text-lg">
            We&apos;re just minutes away. Call now for immediate service anywhere in Charlotte County.
          </p>
          <a 
            href="tel:+19415875050" 
